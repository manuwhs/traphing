...
class TestVelas():
    ...
    def test_save_to_csv(self):
        my_vela = get_loaded_Vela()
        storage_folder = test_storage_folder2
    ...
    def test_add_data_from_csv(self):
        ...
        timeframe = Timeframes.M15
        storage_folder = test_storage_folder
        storage2_folder = test_storage_folder2
    ...
    def test_get_series(self):
        options = ["Open", "Close", "High", "Low",
                   "Volume", "Average", "RangeHL", "RangeCO"]
        ...
        for name in options:
            ...
            assert np.sum(time_series_data.values) == np.sum(
                time_series_data2.values)
