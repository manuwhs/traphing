...
#include <traphing/util.mqh>
int timeSeries_to_csv(string symbol_name, ENUM_TIMEFRAMES periodo, 
    int Day, int Month,int Year, 
    bool force_showing_of_data_to_download = true){
...
//--- The created file has the name: Files/PERIOD/SYMBOL_PERIOD.csv, i.e. Files/M1/EURUSD_M1.csv
...
bool symbols_info_to_csv(){
   ...
   Downloaded to Files/Symbol_info.csv
   Example:
