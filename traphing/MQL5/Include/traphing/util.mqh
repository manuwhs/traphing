...
string fTimeFrameName(int arg){
 ...
 ENUM_TIMEFRAMES frameName2ENUM_TIMEFRAME(string arg){
    Print(arg);
    if(StringCompare(arg,"M1")== 0){ return(PERIOD_M1);}
    if(StringCompare(arg,"M5")== 0){ return(PERIOD_M5);}
    if(StringCompare(arg,"M15")== 0){ return(PERIOD_M15);}
    if(StringCompare(arg,"M30")== 0){ return(PERIOD_M30);}
    if(StringCompare(arg,"H1")== 0){ return(PERIOD_H1);}
    if(StringCompare(arg,"H4")== 0){ return(PERIOD_H4);}
    if(StringCompare(arg,"D1")== 0){ return(PERIOD_D1);}
    if(StringCompare(arg,"W1")== 0){ return(PERIOD_W1);}
    if(StringCompare(arg,"MN1")== 0){ return(PERIOD_MN1);}
    return PERIOD_D1;
