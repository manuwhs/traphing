...
#include <traphing/socket_lib.mqh>
#include <traphing/util.mqh>
#include <traphing/socket_commands.mqh>
#include <traphing/broker_to_csv.mqh>
            ...
            if (StringCompare("", result) !=0){
               ...
               if (StringCompare(result, "DOWNLOAD_SYMBOLS_INFO")==0){
                 ...
                 //  break;
                  ...
                  success = timeSeries_to_csv(splits[1],frameName2ENUM_TIMEFRAME(splits[2]),splits[3],splits[4],splits[5]);
                  if(success){
                     printf("Successful download");
                     success = socksend(socket, "OK");
                  }
