...
from ... import utils
from ...utils import MarketHours, Timeframes
...
class Symbol:
    def __init__(self, symbol_name: str, timeframes: List[Timeframes],
    ...
    @timeframes.setter
    def timeframes(self, value:  List[Timeframes]):
